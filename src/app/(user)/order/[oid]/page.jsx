...
import DownloadInvoiceButton from 'src/components/_main/orders/downloadInvoice';

// Meta information
export const metadata = {
  title: 'Order Confirmation | Ezone - Your Order Has Been Successfully Placed',
  description:
    'Congratulations! Your order has been successfully placed on Ezone. Thank you for choosing us for your shopping needs. Expect fast processing and delivery. Stay tuned for updates on your order status. Shop more with Ezone!',
  applicationName: 'Ezone',
  authors: 'Ezone',
  keywords:
    'order confirmation, Ezone, order placed, successful order, order processing, order delivery, order status, order updates, fast delivery, shopping confirmation, shopping success, shopping updates, online shopping'
};
    ...
    <Box>
      <Container fixed>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center', mt: 4, mb: 4 }}>
          <DownloadInvoiceButton orderData={data} />
        </Box>
      </Container>
    </Box>
  );
