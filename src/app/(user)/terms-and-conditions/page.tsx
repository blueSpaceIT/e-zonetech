    ...
    <Container fixed>
      <Box sx={{ py: { xs: 3, md: 6 } }}>
        ...
        <Typography paragraph>
          Welcome to E Zone Technologies Trading LLC, one of the Leading IT Supplying Companies in the United Arab
          Emirates.
        </Typography>

        <Typography paragraph>
          This website is controlled and managed by E Zone Technologies Trading LLC. The terms like “we”, “us” and “our”
          used throughout this site refer to E Zone Technologies Trading LLC. This website is offered to you by us,
          including all information, tools and services available from this site to you, the user, conditioned upon your
          acceptance of all terms, conditions, policies and notices stated here. By visiting our site and/ or purchasing
          something from us, you engage in our “Service” and agree to be bound by the following terms and conditions
          (“Terms of Service”, “Terms”), including those additional terms and conditions and policies referenced herein
          and/or available by hyperlink. These “Terms” apply to all users of this site, including without limitation
          users who are browsers, vendors, customers, merchants, and/ or contributors of content. You are advised to
          read these Terms of Service carefully before accessing or using the website. By accessing or using any part of
          the site, you agree to be bound by these Terms of Service. If you do not agree to all or any part of the terms
          and conditions of this agreement, then you may not access the website or use any services. If these Terms of
          Service are considered an offer, acceptance is expressly limited to these Terms of Service. Any new features
          or tools which are added to the current store shall also be subject to the Terms of Service. You can review
          the most current version of the Terms of Service at any time on this page. We reserve the right to update,
          change or replace any part of these Terms of Service by posting updates and/or changes to our website. It is
        ...
        <Typography paragraph>
          ...
          reproduce, duplicate, copy, sell, resell or exploit any portion of the Service, use of the Service, or access
          to the Service or any contact on the website through which the service is provided, without express written
        ...
        <Typography paragraph>
          We are not responsible if information made available on this site is not accurate, incomplete or current. The
          ...
          obligation to update any information on our site. You agree that it is your responsibility to monitor changes
          to our site.
        </Typography>
        ...
        <Typography paragraph>
          ...
          Policy. We have made every effort to display as accurately as possible the colours and images of our products
          ...
          person, geographic region or jurisdiction. We may exercise this right on a case-by-case basis. We reserve the
          right to limit the quantities of any products or services that we offer. All descriptions of products or
          product pricing are subject to change at any time without notice, at the sole discretion of us. We reserve the
          right to discontinue any product at any time. Any offer for any product or service made on this site is void
          where prohibited. We do not warrant that the quality of any products, services, information, or other material
        ...
        <Typography paragraph>
          ...
          contacting at the e-mail and/or billing address/phone number provided at the time the order was placed. We
          ...
          information, including your email address and credit card numbers and expiration dates so that we can complete
        ...
        <Typography paragraph>
          ...
          may also, in the future, offer new services and/or features through the website (including, the release of new
        ...
        <Typography paragraph>
          ...
          use of goods, services, resources, content, or any other transactions made in connection with any third-party
        ...
        <Typography paragraph>
          ...
          edit or remove content that we determine in our sole discretion are unlawful, offensive, threatening,
          libellous, defamatory, pornographic, obscene or otherwise objectionable or violates any party’s intellectual
          ...
          further agree that your comments will not contain libellous or otherwise unlawful, abusive or obscene
          material, or contain any computer virus or other malware that could in any way affect the operation of the
          Service or any related website. You may not use a false e-mail address, pretend to be someone other than
        ...
        <Typography paragraph>
          ...
          website, including without limitation, pricing information, except as required by law. No specified update or
        ...
        <Typography paragraph>
          ...
          durability, title, and non-infringement. In no case shall E Zone Technologies Trading LLC, our directors,
        ...
        <Typography paragraph>
          You agree to indemnify, defend and hold harmless E Zone Technologies Trading LLC and our parent, subsidiaries,
        ...
        <Typography paragraph>
          ...
          including the date of termination; and/or accordingly may deny you access to our Services (or any part
          thereof).
        </Typography>
        ...
        <Typography paragraph>
          ...
          us and govern your use of the Service, superseding any prior or contemporaneous agreements, communications and
          proposals, whether oral or written, between you and us (including, but not limited to, any prior versions of
          the Terms of Service). Any ambiguities in the interpretation of these Terms of Service shall not be construed
        ...
        <Typography paragraph>
          ...
          construed in accordance with the laws of Dubai, UAE
        </Typography>
        ...
        <Typography paragraph>
          Any dispute or claim arising out of or in connection with this website shall be governed and construed in
          accordance with the laws of UAE.
        </Typography>

        <Typography paragraph>United Arab of Emirates is our country of domicile.</Typography>

        <Typography paragraph>
          Minors under the age of 18 are prohibited to register as a User of this website and are not allowed to
          transact or use the website.
        </Typography>

        <Typography paragraph>
          If you make a payment for our products or services on our website, the details you are asked to submit will be
          provided directly to our payment provider via a secured connection.
        </Typography>
