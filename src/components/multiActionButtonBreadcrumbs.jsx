...
export default function MultiActionButtonBreadcrumbs({ ...props }) {
  const { links, actions, icon, heading, moreLink = '' || [], sx, admin, ...other } = props;
...
MultiActionButtonBreadcrumbs.propTypes = {
